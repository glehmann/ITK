 ...
 * computes the threshold using the HuangThresholdImageCalculator and
 ...
 *
 * \sa HuangThresholdImageCalculator
...
public:
  ...
  itkTypeMacro(HuangThresholdImageFilter, ImageToImageFilter);
...
#include "itkHuangThresholdImageFilter.hxx"
#endif
