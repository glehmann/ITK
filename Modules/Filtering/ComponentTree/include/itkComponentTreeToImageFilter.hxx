/*=========================================================================
  ...
  Module:    $RCSfile: itkComponentTreeToImageFilter.hxx,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkComponentTreeToImageFilter_hxx
#define __itkComponentTreeToImageFilter_hxx
...
::WriteNodes( const NodeType* node )
{
  ...
  for( typename NodeType::ChildrenListType::const_iterator it=childrenList->begin();
       it != childrenList->end();
       it++ )
    {
    this->WriteNodes( *it );
