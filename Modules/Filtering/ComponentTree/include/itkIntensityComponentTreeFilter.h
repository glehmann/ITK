/*=========================================================================
  ...
  Module:    $RCSfile: itkIntensityComponentTreeFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkIntensityComponentTreeFilter_h
#define __itkIntensityComponentTreeFilter_h
...
public:
  ...
  itkTypeMacro(IntensityComponentTreeFilter,
               ImageToImageFilter);
...
private:
  IntensityComponentTreeFilter(const Self&); //purposely not implemented
...
#include "itkIntensityComponentTreeFilter.hxx"
#endif
