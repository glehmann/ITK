/*=========================================================================
  ...
  Module:    $RCSfile: itkMonotoneComponentTreeFilter.hxx,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkMonotoneComponentTreeFilter_hxx
#define __itkMonotoneComponentTreeFilter_hxx
...
::GenerateData()
{
  if( m_StrictlyMonotone && !m_RemoveNodes )
    {
    itkWarningMacro( "MonotoneComponentTreeFilter can't make the attributes strictly monotones when it can't remove nodes." << std::endl
                     << "You should either set RemoveNodes to true, or set StrictlyMonotone to false." );
    }
