/*=========================================================================
  ...
  Module:    $RCSfile: itkShapeComponentTreeFilter.hxx,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkShapeComponentTreeFilter_hxx
#define __itkShapeComponentTreeFilter_hxx
...
::SetAttribute( NodeType* node )
{
  ...
  for( typename NodeType::ChildrenListType::const_iterator it=childrenList->begin(); it != childrenList->end(); it++ )
    ...
    typename LabelObjectType::ConstLineIterator lit(childLabelObject);
    while( ! lit.IsAtEnd() )
      {
      labelObject->AddLine(lit.GetLine());
      ++lit;
      }
    }
