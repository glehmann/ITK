/*=========================================================================
  ...
  Module:    $RCSfile: itkShiftComponentTreeFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkShiftComponentTreeFilter_h
#define __itkShiftComponentTreeFilter_h
...
namespace itk {
/** \class ShiftComponentTreeFilter
 * \brief TODO
 *
...
class ITK_EXPORT ShiftComponentTreeFilter :
    public InPlaceComponentTreeFilter<TImage>
{
public:
  /** Standard class typedefs. */
  typedef ShiftComponentTreeFilter           Self;
  ...
  itkTypeMacro(ShiftComponentTreeFilter,
...
protected:
  ...
  void GenerateData();
  void SetAttributeValue( NodeType* );

private:
  ShiftComponentTreeFilter(const Self&); //purposely not implemented
...
#include "itkShiftComponentTreeFilter.hxx"
#endif
